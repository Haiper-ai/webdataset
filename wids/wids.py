...
def splitname(fname):
    """Returns the basename and extension of a filename with support for multiple dots in the basename."""
    assert "." in fname, "Filename must have an extension"
    # Update the regular expression to capture everything up to the last dot as the basename
